...
-(UIImageView *)shotsImageView{
    if (_shotsImageView == nil) {
        _shotsImageView = [[UIImageView alloc]initWithFrame:CGRectMake((MainWidth-DPAdaptationW(274))/2, kTopHeight, DPAdaptationW(274), DPAdaptationH(474))];
...
-(UIView *)bottomView{
    if (_bottomView == nil) {
        _bottomView = [[UIView alloc] initWithFrame:CGRectMake(0, MainHeight, MainWidth, DPAdaptationH(160)+SafeAreaBottomHeight)];
...
-(void)hiddenView{
    ...
    [UIView animateWithDuration:0.5 animations:^{
        self.shotsImageView.frame = CGRectMake((MainWidth-DPAdaptationW(274))/2, DPAdaptationH(120), DPAdaptationW(274), DPAdaptationH(474));
...
-(void)layoutBottomSubViews{
    ...
    [WeiXinButton setTitle:CALanguages(@"微信好友") forState:UIControlStateNormal];
    ...
    [WeiXinCircleButton setTitle:CALanguages(@"朋友圈") forState:UIControlStateNormal];
    ...
    [saveButton setTitle:CALanguages(@"保存图片")  forState:UIControlStateNormal];
    ...
    UIButton *btn = [[UIButton alloc] initWithFrame:CGRectMake(0, DPAdaptationH(110)-SafeKLineBottomHeight, MainWidth, 50)];
    [btn setTitle:CALanguages(@"取消") forState:UIControlStateNormal];
